    ...
    <li class="has-submenu mega">
      ...
      <div class="submenu-content">
        ...
        <div class="m-2e bt-thin pt-2e">
          A few examples of <a href="../codebase/5-components/menus.html">menus</a>, <a href="../codebase/5-components/cards.html">cards</a>, <a href="../codebase/2-basics/form-elements.html">forms elements</a> and <a href="../codebase/5-components/buttons.html">buttons</a> that can be placed within a Codebase megamenu panel. Control the panel layout using <a href="../codebase/3-layout/flexbox.html">flexbox</a> or <a href="../codebase/3-layout/grid.html">grid</a> classes.
        </div>
      </div>
    </li>
...
(However, in the layout for these docs the this megamenu has been <a href="../codebase/4-utilities/invisibility.html">hidden</a> in offcanvas mode, and the main sidebar has been used as a responsive <a href="../codebase/5-components/offcanvas.html">offcanvas</a> panel instead.</div>
...
<div class="bg-theme-2 p-2e">Megamenu not big enough for you? Try a <a href="../codebase/5-components/modals.html#full-cover-modal">Full-Cover Modal</a>.</div>